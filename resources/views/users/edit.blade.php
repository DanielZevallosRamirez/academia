        ...
        <form method="POST" action="{{ route('users.update', $user) }}" enctype="multipart/form-data" class="p-6 space-y-6" x-data="{ role: '{{ $user->role }}' }">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="role" value="secretario" x-model="role" class="peer sr-only" {{ $user->role === 'secretario' ? 'checked' : '' }}>
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="role" value="administrativo" x-model="role" class="peer sr-only" {{ $user->role === 'administrativo' ? 'checked' : '' }}>
