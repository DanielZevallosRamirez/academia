...
@section('title', 'Codigo QR - ' . $student->name)
@section('page-title', 'Codigo QR del Estudiante')

@section('content')
<div class="max-w-lg mx-auto">
    <div class="mb-6">
        <a href="{{ route('students.show', $student) }}" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-8 text-center">
        ...
        <p class="mt-4 text-sm text-gray-500">
            Codigo: <span class="font-mono">{{ $student->qr_code }}</span>
        </p>
        ...
        <div class="mt-8 flex flex-col gap-3">
            ...
            <form method="POST" action="{{ route('students.regenerate-qr', $student) }}" 
...
function downloadQR() {
    ...
    img.onload = function() {
        ...
        link.download = 'qr-{{ $student->dni ?? $student->id }}.png';
